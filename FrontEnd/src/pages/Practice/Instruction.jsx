    ...
    <div className="ml-24 mt-4">
      ...
      <div className="p-6">
        <div className="flex items-center mb-4">
          ...
          <Heading size="8">Instruction For Readers</Heading>
        </div>
        <Text className="text-sm text-gray-600 mb-4">
          Rapid Read is a tool designed to help you improve your reading speed
          and comprehension. Follow the instructions below to get started:
        </Text>
        <ol className="list-decimal pl-5">
          <li className="text-gray-800 mb-2">
            Select a reading material from the provided options.
          </li>
          <li className="text-gray-800 mb-2">
            Adjust the reading speed using the controls.
          </li>
          <li className="text-gray-800 mb-2">
            Focus on reading the text as quickly as possible while maintaining
            comprehension.
          </li>
          <li className="text-gray-800 mb-2">
            Track your progress and see how your reading speed improves over
            time.
          </li>
        </ol>
        <div className="mt-6">
