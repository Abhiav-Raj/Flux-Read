...
const chatbotData = [
  ...
  },
  {
    ...
    answer:
      "I can answer your questions about using this platform and provide helpful tips.",
  },
  {
...
function Chatbot() {
  ...
  const [suggestions, setSuggestions] = useState(["Hi", "What can you do?"]);
  ...
  const handleSendMessage = async (customText) => {
    const userMessage = customText || message;
    ...
    try {
      ...
      const userPrompt =
        "Here is my Instructions for you \n\n" +
      ...
      setMessages((prevMessages) => [
        ...prevMessages,
        { text: response.text(), sender: "chatbot" },
      ]);
    } catch (error) {
      console.error("Error:", error);
      setMessages((prevMessages) => [
        ...prevMessages,
        { text: "Something went wrong. Please try again.", sender: "chatbot" },
      ]);
    } finally {
      setIsTyping(false);
    }
