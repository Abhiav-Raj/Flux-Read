      ...
      <Container size="7">
        <Box className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <Text>Bihar Sharif,Bihar, India</Text>
            <Text>Email: abhinav.raj7374@gmail.com</Text>
            <Text>Phone: 7033395280</Text>
          </div>
        </Box>
        <Box mt="8" textAlign="center" className="mb-4 text-center">
          <Text>
            &copy; {new Date().getFullYear()} Rapid Read. All rights reserved.
          </Text>
        </Box>
      </Container>
    </Box>
