        ...
        <Container size="7" py="4">
          <div className="flex justify-between items-center">
            ...
            <nav className="flex justify-center space-x-4">
                  ...
                  <DropdownMenu.Item
                    ...
                    onClick={() => {
                      if (!loggedIn) {
                        ...
                        window.location.href = "/result"; // Navigate to result page
                      }
                    }}
                  >
                    Result
              ...
              <Link to="/community" color="gray">
                Community{" "}
                {loggedIn ? "" : <FaLock className="ml-2 mb-1 inline" />}
              </Link>
              <Link to="/contact" color="gray">
                Contact
              </Link>
            </nav>
