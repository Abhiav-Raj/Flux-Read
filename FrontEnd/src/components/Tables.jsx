...
function Tables() {
  ...
  const data = [
    { rank: 1, name: 'Rahul Kumar', speed: '250 w/m' },
    { rank: 2, name: 'Aditya Chaudhry', speed: '248 w/m' },
    { rank: 3, name: 'Sahil Ali', speed: '238 w/m' },
    { rank: 4, name: 'Bishnu Parsad', speed: '235 w/m' },
    { rank: 5, name: 'Rihana Sharma', speed: '230 w/m' },
    { rank: 6, name: 'Ritik Agarwal', speed: '225 w/m' },
    { rank: 7, name: 'Arun Raj', speed: '220 w/m' },
    { rank: 8, name: 'Ravi Kumar', speed: '215 w/m' },
    { rank: 9, name: 'Ram Prasad', speed: '210 w/m' },
    { rank: 10, name: 'Ahana Singh', speed: '205 w/m' },
  ]
