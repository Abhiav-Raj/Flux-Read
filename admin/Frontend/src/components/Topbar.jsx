      ...
      <div className="flex">
        <div>
          <div className="my-auto ml-2">
            ...
            <IoSpeedometerOutline
              className="ml-2 mb-1 text-[#3859C7] mr-2 inline-block"
              size={20}
            />
            <div
              className={`relative inline-block ${
                open ? "mt-3 left-[0px]" : "-left-[190px]"
              } duration-300`}
            >
              <div className="text-md font-medium text-[#3859C7] duration-150">
                Rapid Read
              </div>
            </div>

            <div className="fixed left-0 top-0 bg-white w-[10px] h-[50px] text-white">
              .
            </div>
          </div>
        </div>
